...
class SupabaseStore:
    ...
    def update_automation_settings(
        ...
        *,
        ...
        record = {
            ...
            "min_new_messages_threshold": max(
                20,
                min_new_messages_threshold if min_new_messages_threshold is not None else current.min_new_messages_threshold,
            ),
    ...
    def _parse_automation_settings(self, value: Any, *, fallback_user_id: UUID) -> AutomationSettingsRecord | None:
        ...
        return AutomationSettingsRecord(
            ...
            min_new_messages_threshold=max(20, self._parse_int(value.get("min_new_messages_threshold")) or 20),
