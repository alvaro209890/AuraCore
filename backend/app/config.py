...
class Settings(BaseSettings):
    ...
    memory_analysis_max_messages: int = Field(360, alias="MEMORY_ANALYSIS_MAX_MESSAGES")
    memory_analysis_max_chars: int = Field(85000, alias="MEMORY_ANALYSIS_MAX_CHARS")
    memory_analysis_max_window_hours: int = Field(336, alias="MEMORY_ANALYSIS_MAX_WINDOW_HOURS")
    memory_analysis_context_snapshots: int = Field(6, alias="MEMORY_ANALYSIS_CONTEXT_SNAPSHOTS")
    memory_analysis_snapshot_context_chars: int = Field(18000, alias="MEMORY_ANALYSIS_SNAPSHOT_CONTEXT_CHARS")
    chat_max_history_messages: int = Field(20, alias="CHAT_MAX_HISTORY_MESSAGES")
    chat_context_snapshots: int = Field(6, alias="CHAT_CONTEXT_SNAPSHOTS")
    chat_context_projects: int = Field(10, alias="CHAT_CONTEXT_PROJECTS")
    chat_context_chars: int = Field(22000, alias="CHAT_CONTEXT_CHARS")
    chat_max_message_chars: int = Field(2000, alias="CHAT_MAX_MESSAGE_CHARS")
    message_retention_max_rows: int = Field(5000, alias="MESSAGE_RETENTION_MAX_ROWS")
